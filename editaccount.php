...
<div id="x">
	<div id="y">
		...
		<input type ="text" name="ou" placeholder="Old user name"><br>
		<label>New User Name</label>
		<input type ="text" name="nu" placeholder="new user name "><br>
		<label>Name</label>
		<input type ="text" name="n" placeholder="new name"><br>
